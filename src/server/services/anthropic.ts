  ...
  "phases": [
    {
      ...
      config: {
        ...
        temperature: 0.4,
        systemInstruction: 'You are a senior learning architect. Prefer official documentation links when they exist. Include a balanced mix of free and paid resources.',
      }
    });
    ...
    throw new AppError(502, `AI response could not be generated: ${error.message || error}`, 'AI_GENERATE_FAILED');
  }
}
