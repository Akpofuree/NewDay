...
export default function NewTaskModal({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!title.trim()) {
      setValidationError(
        "A clear and descriptive task Title represents a required field.",
      );
      return;
    }
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 font-sans">
      ...
      <div
        className="relative w-full max-w-lg rounded-2xl glass-panel shadow-2xl p-6 overflow-hidden animate-zoom-in pointer-events-auto"
        style={{
      ...
      >
        ...
        {/* Modal Header */}
        <div className="flex items-center justify-between pb-4 border-b border-gray-200/50 dark:border-white/5 mb-5">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <p className="text-[9px] text-gray-400 mt-1">
              Add up to 8 tags. Tags are lowercase, unique, and max 20
              characters.
            </p>
          </div>
          ...
          {/* Form Actions footer */}
          <div className="flex justify-end gap-3.5 pt-4 border-t border-gray-200/50 dark:border-white/5 mt-6">
            <button
              type="button"
              onClick={onClose}
