...
ops.filter((o) => o.line <= 40).forEach((o) => console.log(o));
console.log("...");
ops
  .filter((o) => o.line >= 220 && o.line <= 340)
  .forEach((o) => console.log(o));
console.log("...");
ops.filter((o) => o.line > 340).forEach((o) => console.log(o));
console.log("remaining", stack.length, stack.slice(-5));
